...
:jump_ahead: Set up Spring Security
...
At this point, you could jump ahead to the _<<run>>_ section and run the application. The logout link won't work, but otherwise it's a functioning Spring MVC application.
